...
export const fetchPaymentPeriod = (): AppThunk => async (
  dispatch,
  _,
  { api }
) => {
...
export const fetchCurrentPeriod = (): AppThunk => async (
  dispatch,
  _,
  { api }
) => {
...
export const fetchEmailTemplate = (kind: EmailKind): AppThunk => async (
  dispatch,
  _,
  { api }
) => {
...
export const updatePaymentPeriod = (paymentPeriod: Period): AppThunk => async (
  dispatch,
  _,
  { api }
) => {
...
export const updateCurrentPeriod = (currentPeriod: Period): AppThunk => async (
  dispatch,
  _,
  { api }
) => {
