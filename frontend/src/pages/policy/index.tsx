...
const Chapter: React.FC<React.PropsWithChildren<{
  chapter: string,
  descriptions: string[],
}>> = ({
  ...
  return (
    <div style={{marginTop: 30}}>
      <Typography variant='h5' margin={1}><strong>{chapter}</strong></Typography>
      {
...
const Page: NextPage = () => {
  return (
    <NoSSR>
      <div style={{margin: 10}}>
        <Typography variant='h5' margin={1}><strong>プライバシーポリシー</strong></Typography>
        <div>
          <p>
