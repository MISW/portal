...
export const fetchCurrentUser = createAppAsyncThunk('currentUser/fetch', async (_, { dispatch, extra: { api } }) => {
...
export const updateCurrentUser = createAppAsyncThunk(
  'currentUser/update',
  async (updateInput: Partial<UpdateUserProfileInput>, { dispatch, getState, extra: { api } }) => {
