...
export const selectPaymentPeriod: Selector<Period | undefined> = (state) => state.appconfig.paymentPeriod;

export const selectCurrentPeriod: Selector<Period | undefined> = (state) => state.appconfig.currentPeriod;
