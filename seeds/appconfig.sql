...
(
  ...
  '{"subject":"【重要】MISW会費のお支払について","body":"{{.User.Handle}}さん\\nかねてからMISWにご入会していただき誠にありがとうございます。\\nまだ、サークル費の振り込みが確認できていない旨をお知らせさせていただきます。\\nMISWへの会員継続をするには半期のサークル費を指定の銀行振込にお支払いしていただく必要があります。\\n会費を支払わない場合、自動的にサークル退会とみなし、公式Discord・Kibela・みすクラウド等が使用できなくなります。ご了承ください。\\n早稲田大学経営情報学会(MISW)\\n"}',
  '2023-04-01 00:00:00',
  '2023-04-01 00:00:00'
),
(
