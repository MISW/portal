...
// Source: user_role_rrepository.go
...
func (m *MockUserRoleRepository) UpdateWithRule(ctx context.Context, id int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateWithRule", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateWithRule indicates an expected call of UpdateWithRule
func (mr *MockUserRoleRepositoryMockRecorder) UpdateWithRule(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateWithRule", reflect.TypeOf((*MockUserRoleRepository)(nil).UpdateWithRule), ctx, id)
}

// UpdateAllWithRule mocks base method
func (m *MockUserRoleRepository) UpdateAllWithRule(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateAllWithRule", ctx)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateAllWithRule indicates an expected call of UpdateAllWithRule
func (mr *MockUserRoleRepositoryMockRecorder) UpdateAllWithRule(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAllWithRule", reflect.TypeOf((*MockUserRoleRepository)(nil).UpdateAllWithRule), ctx)
}
